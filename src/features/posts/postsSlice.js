...
export const savePost = createAsyncThunk(
  ...
  async ({ userId, postContent, file }) => {
    try {
      ...
      const postsRef = collection(db, `users/${userId}/posts`);
      // Since no ID is given, Firestore auto-generates a unique ID for new documents
...
// Async thunk to add a like to a post
...
// Async thunk to remove a like from a post
